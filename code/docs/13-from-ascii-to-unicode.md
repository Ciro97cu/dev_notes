...
<svg viewBox="0 0 400 112" role="img" aria-label="A e a in ASCII differiscono di un solo bit, quello del valore 32" style="width:100%;max-width:440px;height:auto;color:inherit">
...
<svg viewBox="0 0 470 190" role="img" aria-label="Codifica UTF-8 del carattere sterlina U+00A3 nei due byte C2 A3" style="width:100%;max-width:470px;height:auto;color:inherit">
  <g font-family="system-ui,Arial,sans-serif" fill="currentColor">
    ...
    <g stroke="currentColor" stroke-width="1.2" opacity=".5" fill="none">
      <path d="M155 60 L171 112"/>
      <path d="M303 60 L379 112"/>
    </g>
...
<figcaption style="font-size:.82rem;opacity:.7;margin-top:.3rem">I bit <strong>colorati</strong> (<code>110…</code> e <code>10…</code>) sono il prefisso fisso di UTF-8; gli altri sono i bit del code point. Gli 11 bit di <code>U+00A3</code> vengono spezzati 5 + 6 e incastonati nei prefissi <code>110…</code> e <code>10…</code>: risultano i byte <code>C2h A3h</code>. Allo stesso modo <code>א</code> (<code>U+05D0</code>) diventa <code>D7 90</code>, e la faccina di gatto <code>U+1F639</code>, a 4 byte, diventa <code>F0 9F 98 B9</code>.</figcaption>
</figure>
...
<svg viewBox="0 0 460 176" role="img" aria-label="Gli stessi tre byte E2 80 99 letti come UTF-8 o come Windows-1252" style="width:100%;max-width:460px;height:auto;color:inherit">
  <g font-family="system-ui,Arial,sans-serif" fill="currentColor">
    ...
    <g stroke="currentColor" stroke-width="1.3" fill="none" opacity=".6">
      <path d="M241 78 V40" marker-end="url(#av)"/>
      <path d="M241 112 V150" marker-end="url(#av)"/>
    </g>
    ...
    <text x="241" y="30" font-size="13" text-anchor="middle">come UTF-8 → ’ (un carattere: U+2019)</text>
    <text x="241" y="168" font-size="13" text-anchor="middle">come Windows-1252 → â € ™ (tre caratteri)</text>
  </g>
</svg>
