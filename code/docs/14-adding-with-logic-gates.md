...
<figure style="margin:1rem 0;text-align:center">
<svg viewBox="0 0 470 210" role="img" aria-label="Full adder costruito con due half adder e una porta OR" style="width:100%;max-width:470px;height:auto;color:inherit">
...
<figure style="margin:1rem 0;text-align:center">
<svg viewBox="0 0 486 150" role="img" aria-label="Adder a 8 bit: otto full adder in catena con il riporto che si propaga da destra a sinistra" style="width:100%;max-width:600px;height:auto;color:inherit">
