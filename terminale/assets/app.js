/*
 * Parti SPECIFICHE del vault Terminale: wikilink (capitoli in /docs/) e la
 * configurazione window.$docsify. Anti-flash e plugin condivisi (tema, mermaid,
 * callout, resume, coverDots) vivono in ../assets/shared/ (01-core … 06-highlighter),
 * caricati prima. Nessun playground qui.
 */
window.__VAULT = 'terminale';   // chiave per "Riprendi" (terminale-last-page)

// Risolve i link Obsidian [[nome]] / [[nome|alias]] in link Docsify (a render-time).
// Tutti i capitoli stanno in /docs/, quindi [[NN-...]] -> /docs/NN-....md
...
window.$docsify = {
  ...
  search: {
    namespace: 'dev-notes-terminale', placeholder: 'Cerca…', noData: 'Nessun risultato', depth: 4 },
