...
- **Quando il libro è superato**: se un'affermazione di YDKJS (2015, fino a ES6) **oggi non è più vera** perché il linguaggio è cambiato, e se ne è **certi al 100%**, si corregge e si **segnala** con un callout `> [!info|label:Oggi]` che contrappone *"il libro dice X; oggi vale Y"*. Se invece è solo una semplificazione ancora valida, si resta **fedeli** al libro (non si "corregge" il libro).
