/*
 * Parti SPECIFICHE del vault inglese: solo la configurazione window.$docsify.
 ...
 */
window.__VAULT = 'inglese';   // chiave per "Riprendi" (inglese-last-page)
