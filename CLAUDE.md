...
- **Spiegazione autosufficiente, non "risposta"**: una nota — anche quando nasce da una domanda in chat — si scrive come **esposizione che sta in piedi da sola**, non come replica alla domanda. Vietate le frasi **reattive/meta** che tradiscono l'origine o si rivolgono a chi fatica (*"il modo più utile per fissare il concetto…"*, *"il punto che rovescia l'intuizione…"*, *"come ti chiedevi…"*): si **espone** il concetto, non lo si "chiarisce". E nessun tecnicismo lasciato lì (es. *data sink*, *ultimo miglio*): va sciolto alla prima occorrenza, come da *Apertura in parole semplici* qui sopra.
