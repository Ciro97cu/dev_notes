...
> [!info|label:Milestone 1 · Foundations]
> Sono disponibili l'orientamento all'esame, la matrice completa dei 14 task statement, il primo modulo e il laboratorio per predisporre un account di studio sicuro. I moduli successivi vengono pubblicati soltanto dopo verifica tecnica ed editoriale.
...
| 02 | IAM, federation e strategia multi-account | In preparazione |
...
| LAB 02 · Prima architettura serverless | Console + CLI + CloudFormation | In preparazione |
