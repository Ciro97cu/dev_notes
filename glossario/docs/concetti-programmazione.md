...
Quest'ultimo è il caso più insidioso: l'oggetto passato come argomento è **condiviso** col chiamante (per via del [riferimento](docs/concetti-programmazione.md?id=referenza-e-puntatore)), così modificarlo cambia qualcosa fuori dalla funzione anche quando sembra solo un calcolo locale.
