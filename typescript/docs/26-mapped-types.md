...
<svg viewBox="0 0 484 122" role="img" aria-label="Mapped type: per ogni chiave di T si genera una proprietà trasformata" style="width:100%;max-width:500px;height:auto;color:inherit"><g font-family="system-ui,Arial,sans-serif"><text x="78.0" y="39" font-size="10" text-anchor="middle" font-weight="700" opacity="1" fill="currentColor" font-family="system-ui,Arial,sans-serif">Persona</text><rect x="20" y="44" width="116" height="42" rx="5" fill="none" stroke="currentColor" stroke-width="1.5" opacity="1"/><text x="29" y="61" font-size="10.5" text-anchor="start" font-weight="400" opacity=".9" fill="currentColor" font-family="ui-monospace,Menlo,Consolas,monospace">nome: string</text><text x="29" y="76" font-size="10.5" text-anchor="start" font-weight="400" opacity=".9" fill="currentColor" font-family="ui-monospace,Menlo,Consolas,monospace">eta: number</text><text x="395.0" y="39" font-size="10" text-anchor="middle" font-weight="700" opacity="1" fill="currentColor" font-family="system-ui,Arial,sans-serif">Readonly&lt;Persona&gt;</text><rect x="320" y="44" width="150" height="42" rx="5" fill="none" stroke="currentColor" stroke-width="1.5" opacity="1"/><text x="329" y="61" font-size="10.5" text-anchor="start" font-weight="700" opacity="1" fill="var(--link,#3178c6)" font-family="ui-monospace,Menlo,Consolas,monospace">readonly nome: string</text><text x="329" y="76" font-size="10.5" text-anchor="start" font-weight="700" opacity="1" fill="var(--link,#3178c6)" font-family="ui-monospace,Menlo,Consolas,monospace">readonly eta: number</text><text x="228" y="20" font-size="10.5" text-anchor="middle" font-weight="700" opacity="1" fill="currentColor" font-family="ui-monospace,Menlo,Consolas,monospace">[K in keyof T]</text><text x="228" y="33" font-size="8.5" text-anchor="middle" font-weight="400" opacity=".7" fill="currentColor" font-family="system-ui,Arial,sans-serif">per ogni chiave K</text><path d="M136 61 L318 61" fill="none" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" opacity=".55"/><path d="M318 61 L310 56 L310 66 Z" fill="currentColor"/><path d="M136 76 L318 76" fill="none" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" opacity=".55"/><path d="M318 76 L310 71 L310 81 Z" fill="currentColor"/></g></svg>
<figcaption style="font-size:.82rem;opacity:.7;margin-top:.3rem">Un <strong>mapped type</strong> <code>{ [K in keyof T]: … }</code> scorre le chiavi di <code>T</code> e per ognuna genera una proprietà, applicando eventuali modificatori (<code>readonly</code>, <code>?</code>, con <code>+</code>/<code>-</code>).</figcaption>
</figure>
