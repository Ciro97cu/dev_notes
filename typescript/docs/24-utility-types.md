...
<svg viewBox="0 0 470 350" role="img" aria-label="Utility type come trasformazioni di forma: Partial, Pick, Omit, Record" style="width:100%;max-width:470px;height:auto;color:inherit"><g font-family="system-ui,Arial,sans-serif"><text x="152" y="62.0" font-size="9.5" text-anchor="end" font-weight="700" opacity="1" fill="currentColor" font-family="ui-monospace,Menlo,Consolas,monospace">Partial&lt;T&gt;</text><rect x="168" y="43.0" width="90" height="42" rx="5" fill="none" stroke="currentColor" stroke-width="1.5" opacity="1"/><text x="177" y="60.0" font-size="10.5" text-anchor="start" font-weight="400" opacity=".9" fill="currentColor" font-family="ui-monospace,Menlo,Consolas,monospace">id</text><text x="177" y="75.0" font-size="10.5" text-anchor="start" font-weight="400" opacity=".9" fill="currentColor" font-family="ui-monospace,Menlo,Consolas,monospace">nome</text><rect x="350" y="43.0" width="90" height="42" rx="5" fill="none" stroke="currentColor" stroke-width="1.5" opacity="1"/><text x="359" y="60.0" font-size="10.5" text-anchor="start" font-weight="700" opacity="1" fill="var(--link,#3178c6)" font-family="ui-monospace,Menlo,Consolas,monospace">id?</text><text x="359" y="75.0" font-size="10.5" text-anchor="start" font-weight="700" opacity="1" fill="var(--link,#3178c6)" font-family="ui-monospace,Menlo,Consolas,monospace">nome?</text><path d="M266 62.0 L340 62.0" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" opacity="1"/><path d="M348 62.0 L340 57.0 L340 67.0 Z" fill="currentColor"/><text x="152" y="142.0" font-size="9.5" text-anchor="end" font-weight="700" opacity="1" fill="currentColor" font-family="ui-monospace,Menlo,Consolas,monospace">Pick&lt;T, "id"|"nome"&gt;</text><rect x="168" y="108.0" width="90" height="72" rx="5" fill="none" stroke="currentColor" stroke-width="1.5" opacity="1"/><text x="177" y="125.0" font-size="10.5" text-anchor="start" font-weight="400" opacity=".9" fill="currentColor" font-family="ui-monospace,Menlo,Consolas,monospace">id</text><text x="177" y="140.0" font-size="10.5" text-anchor="start" font-weight="400" opacity=".9" fill="currentColor" font-family="ui-monospace,Menlo,Consolas,monospace">nome</text><text x="177" y="155.0" font-size="10.5" text-anchor="start" font-weight="400" opacity=".9" fill="currentColor" font-family="ui-monospace,Menlo,Consolas,monospace">email</text><text x="177" y="170.0" font-size="10.5" text-anchor="start" font-weight="400" opacity=".9" fill="currentColor" font-family="ui-monospace,Menlo,Consolas,monospace">pwd</text><rect x="350" y="123.0" width="90" height="42" rx="5" fill="none" stroke="currentColor" stroke-width="1.5" opacity="1"/><text x="359" y="140.0" font-size="10.5" text-anchor="start" font-weight="400" opacity=".9" fill="currentColor" font-family="ui-monospace,Menlo,Consolas,monospace">id</text><text x="359" y="155.0" font-size="10.5" text-anchor="start" font-weight="400" opacity=".9" fill="currentColor" font-family="ui-monospace,Menlo,Consolas,monospace">nome</text><path d="M266 142.0 L340 142.0" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" opacity="1"/><path d="M348 142.0 L340 137.0 L340 147.0 Z" fill="currentColor"/><text x="152" y="222.0" font-size="9.5" text-anchor="end" font-weight="700" opacity="1" fill="currentColor" font-family="ui-monospace,Menlo,Consolas,monospace">Omit&lt;T, "pwd"&gt;</text><rect x="168" y="188.0" width="90" height="72" rx="5" fill="none" stroke="currentColor" stroke-width="1.5" opacity="1"/><text x="177" y="205.0" font-size="10.5" text-anchor="start" font-weight="400" opacity=".9" fill="currentColor" font-family="ui-monospace,Menlo,Consolas,monospace">id</text><text x="177" y="220.0" font-size="10.5" text-anchor="start" font-weight="400" opacity=".9" fill="currentColor" font-family="ui-monospace,Menlo,Consolas,monospace">nome</text><text x="177" y="235.0" font-size="10.5" text-anchor="start" font-weight="400" opacity=".9" fill="currentColor" font-family="ui-monospace,Menlo,Consolas,monospace">email</text><text x="177" y="250.0" font-size="10.5" text-anchor="start" font-weight="400" opacity=".9" fill="currentColor" font-family="ui-monospace,Menlo,Consolas,monospace">pwd</text><rect x="350" y="195.5" width="90" height="57" rx="5" fill="none" stroke="currentColor" stroke-width="1.5" opacity="1"/><text x="359" y="212.5" font-size="10.5" text-anchor="start" font-weight="400" opacity=".9" fill="currentColor" font-family="ui-monospace,Menlo,Consolas,monospace">id</text><text x="359" y="227.5" font-size="10.5" text-anchor="start" font-weight="400" opacity=".9" fill="currentColor" font-family="ui-monospace,Menlo,Consolas,monospace">nome</text><text x="359" y="242.5" font-size="10.5" text-anchor="start" font-weight="400" opacity=".9" fill="currentColor" font-family="ui-monospace,Menlo,Consolas,monospace">email</text><path d="M266 222.0 L340 222.0" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" opacity="1"/><path d="M348 222.0 L340 217.0 L340 227.0 Z" fill="currentColor"/><text x="152" y="302.0" font-size="9.5" text-anchor="end" font-weight="700" opacity="1" fill="currentColor" font-family="ui-monospace,Menlo,Consolas,monospace">Record&lt;K, V&gt;</text><rect x="162" y="294.0" width="104" height="20" rx="10" fill="none" stroke="currentColor" stroke-width="1.5" opacity="1"/><text x="214.0" y="308.0" font-size="10.5" text-anchor="middle" font-weight="700" opacity="1" fill="currentColor" font-family="ui-monospace,Menlo,Consolas,monospace">"a" | "b" | "c"</text><rect x="350" y="275.5" width="90" height="57" rx="5" fill="none" stroke="currentColor" stroke-width="1.5" opacity="1"/><text x="359" y="292.5" font-size="10.5" text-anchor="start" font-weight="700" opacity="1" fill="var(--link,#3178c6)" font-family="ui-monospace,Menlo,Consolas,monospace">a: V</text><text x="359" y="307.5" font-size="10.5" text-anchor="start" font-weight="700" opacity="1" fill="var(--link,#3178c6)" font-family="ui-monospace,Menlo,Consolas,monospace">b: V</text><text x="359" y="322.5" font-size="10.5" text-anchor="start" font-weight="700" opacity="1" fill="var(--link,#3178c6)" font-family="ui-monospace,Menlo,Consolas,monospace">c: V</text><path d="M266 302.0 L340 302.0" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" opacity="1"/><path d="M348 302.0 L340 297.0 L340 307.0 Z" fill="currentColor"/></g></svg>
<figcaption style="font-size:.82rem;opacity:.7;margin-top:.3rem">Gli utility type trasformano la <strong>forma</strong> di un tipo: <code>Partial</code> rende ogni proprietà opzionale (<code>?</code>), <code>Pick</code> ne seleziona alcune, <code>Omit</code> le esclude, <code>Record</code> costruisce un oggetto da un'union di chiavi.</figcaption>
</figure>
