...
## Come navigare
- **Sidebar** a sinistra: capitoli in ordine + concetti raggruppati.
- **Cerca** (in alto): ricerca full-text su tutte le note.
- 🗺️ Mappa completa con tutti i link: **[Indice completo](/00-index.md)**.
- 🆕 Novità Angular 22: cerca il tag `angular-22` o i callout *Angular 22+* nelle note.
