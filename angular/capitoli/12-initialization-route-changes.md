...
<span style="color:var(--theme-color,var(--text-accent))">➕ *(Fuori dal libro Modern Angular — feature standard di Angular, aggiunta qui perché utile per il debug del routing.)*</span>
